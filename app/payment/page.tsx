        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-2xl p-10 mb-10 text-left">
            ...
            <div className="space-y-4">
              {[
                ...
                <div key={opt.title} className="flex items-start gap-5 p-5 border border-gray-200 rounded-xl hover:border-[#CC0000]/30 transition-all bg-white">
                  <div className="text-3xl">{opt.icon}</div>
                  <div className="flex-1">
                    <h3 className="font-semibold mb-1">{opt.title}</h3>
                    <p className="text-gray-500 text-sm mb-3">{opt.desc}</p>
                    <a href={opt.href} className="text-[#CC0000] hover:text-[#b30000] text-sm font-medium transition-colors">{opt.cta} →</a>
                  </div>
                </div>
              ))}
            </div>
          ...
          <div className="bg-red-50 border border-[#CC0000]/20 rounded-2xl p-8 text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a href="tel:8009489914" className="text-[#CC0000] hover:text-[#b30000] text-sm font-medium transition-colors">📞 800.948.9914</a>
              <a href="tel:9198724771" className="text-[#CC0000] hover:text-[#b30000] text-sm font-medium transition-colors">📞 (919) 872-4771</a>
            </div>
          </div>
