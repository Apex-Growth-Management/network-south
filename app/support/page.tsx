    ...
    <main className="bg-[#0a0a0a] text-white pt-16">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-3 gap-6">
          {[
            ...
            <a
              ...
              className="bg-white/[0.03] border border-white/10 rounded-2xl p-8 text-center hover:border-[#CC0000]/40 hover:bg-[#CC0000]/5 transition-all group"
            >
              <div className="text-4xl mb-4">{c.icon}</div>
              <h3 className="font-semibold text-lg mb-2">{c.title}</h3>
              <p className="text-[#ff4444] font-medium mb-1">{c.detail}</p>
              <p className="text-white/40 text-sm mb-4">{c.sub}</p>
              <span className="text-[#CC0000] group-hover:text-[#ff4444] text-sm font-medium transition-colors">{c.cta} →</span>
            </a>
          ))}
        </div>
      </section>
      ...
      <section className="py-24 px-6">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16">
          ...
          <div>
            {submitted ? (
              <div className="bg-[#CC0000]/10 border border-[#CC0000]/20 rounded-2xl p-12 text-center">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-white/[0.05] border border-white/10 rounded-xl px-4 py-3 text-white placeholder-white/20 focus:outline-none focus:border-[#CC0000]/50 transition-colors"
                ...
                <div>
                  ...
                  <select
                    ...
                    value={form.service}
                    onChange={handleChange}
                    className="w-full bg-white/[0.05] border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-[#CC0000]/50 transition-colors"
                  >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    rows={4}
                    className="w-full bg-white/[0.05] border border-white/10 rounded-xl px-4 py-3 text-white placeholder-white/20 focus:outline-none focus:border-[#CC0000]/50 transition-colors resize-none"
                    placeholder="Tell us about your current setup and what you're looking for..."
                  />
                </div>
                <button
                  type="submit"
                  className="w-full bg-[#CC0000] hover:bg-[#b30000] text-white font-semibold py-4 rounded-full transition-colors"
                >
                  Submit Request
                </button>
