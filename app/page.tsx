...
export default function Home() {
  return (
    <main className="bg-[#080c14] text-white">
      {/* Hero */}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {services.map((s) => (
              <div
                key={s.title}
                className="bg-white/[0.03] border border-white/10 rounded-2xl p-7 hover:border-blue-500/40 hover:bg-blue-600/5 transition-all group"
              >
                <div className="text-3xl mb-4">{s.icon}</div>
                <h3 className="text-lg font-semibold mb-2 group-hover:text-blue-300 transition-colors">{s.title}</h3>
                <p className="text-white/50 text-sm leading-relaxed">{s.description}</p>
              </div>
            ))}
          </div>
          <div className="mt-12">
            <Link href="/solutions" className="text-blue-400 hover:text-blue-300 font-medium transition-colors">
              View all solutions →
            </Link>
          </div>
        </div>
      ...
      <section className="relative py-24 px-6 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              <p className="text-blue-400 text-sm font-semibold tracking-widest uppercase mb-3">Why Network South</p>
      ...
      <section className="py-24 px-6 bg-white/[0.01]">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <p className="text-blue-400 text-sm font-semibold tracking-widest uppercase mb-3">Industries We Serve</p>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-7 gap-4">
            {[
              ...
              <Link
                key={ind.label}
                href="/industries"
                className="bg-white/[0.03] border border-white/10 rounded-2xl p-6 text-center hover:border-blue-500/40 hover:bg-blue-600/5 transition-all"
              >
          ...
          <div className="text-center mt-10">
            <Link href="/industries" className="text-blue-400 hover:text-blue-300 font-medium transition-colors">
      ...
      <section className="relative py-28 px-6 overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center">
          <h2 className="text-3xl md:text-5xl font-bold mb-6">
            ...
            <span className="text-blue-400">business communications?</span>
          </h2>
