    ...
    <main className="bg-[#0a0a0a] text-white pt-16">
      ...
      <section className="py-24 px-6 bg-white/[0.02] border-y border-white/10">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {values.map((v) => (
              <div key={v.title} className="bg-white/[0.03] border border-white/10 rounded-2xl p-8 hover:border-[#CC0000]/40 transition-all">
                <div className="w-10 h-10 bg-[#CC0000]/20 rounded-xl flex items-center justify-center mb-5">
                  <div className="w-3 h-3 bg-[#CC0000] rounded-full" />
                </div>
                <h3 className="text-xl font-semibold mb-3 text-[#ff4444]">{v.title}</h3>
      ...
      <section className="py-20 px-6 border-t border-white/10">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <Link
            href="/about/careers"
            className="bg-[#CC0000] hover:bg-[#b30000] text-white font-semibold px-8 py-4 rounded-full transition-colors whitespace-nowrap"
          >
            View Open Positions
          </Link>
        </div>
