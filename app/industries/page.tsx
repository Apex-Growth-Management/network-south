...
const industries = [
  { icon: "🚗", title: "Automotive", description: "Dealerships and service repair shops need reliable departmental communication, call reporting, and customer history access. We deliver phone systems tailored to the fast-paced automotive environment.", features: ["Call reporting & analytics","Multi-department routing","Customer history integration","Service bay communication"] },
  { icon: "🏥", title: "Healthcare", description: "Hospitals, doctor offices, and medical centers need telecom solutions that provide reliable call service while supporting internal patient management systems. We understand HIPAA-compliant communication.", features: ["Patient management integration","HIPAA-compliant solutions","Nurse call systems","Reliable emergency lines"] },
  { icon: "🚛", title: "Transportation", description: "Transportation and professional service companies require seamless dispatch-to-employee connectivity with optimized mobility and call routing capabilities.", features: ["Dispatch integration","Mobile worker solutions","GPS & fleet communication","Optimized call routing"] },
  { icon: "💼", title: "Professional Services", description: "Professional service firms need unified communications that project a polished, reliable image while supporting a distributed workforce and client-facing operations.", features: ["Unified communications","Remote work support","Auto-attendant & voicemail","CRM integration"] },
  { icon: "⚖️", title: "Legal", description: "Law offices handle high call volumes and require unified telecom solutions that support efficient operations, call recording, and secure remote access for attorneys.", features: ["Call recording & archiving","Secure remote access","High call volume support","Conference calling"] },
  { icon: "🎓", title: "Education", description: "Schools and universities need communications that connect teachers, administrators, parents, and students — including mobile applications and video conferencing integration.", features: ["Campus-wide connectivity","Mobile app integration","Video conferencing","Parent & student portals"] },
  { icon: "💡", title: "Technology", description: "Tech companies need telecommunications that can be updated and built upon as new technologies emerge, including web video conferencing and cloud compatibility.", features: ["Cloud-compatible systems","Web video conferencing","Scalable infrastructure","API integrations"] },
];
    ...
    <main className="bg-white text-gray-900 pt-16">
      ...
      <section className="py-24 px-6">
        <div className="max-w-7xl mx-auto grid grid-cols-1 gap-8">
          {industries.map((ind) => (
            <div key={ind.title} className="grid md:grid-cols-2 gap-10 items-center p-8 rounded-2xl border border-gray-200 bg-gray-50 hover:border-[#CC0000]/30 transition-all">
              <div>
                <div className="text-4xl mb-4">{ind.icon}</div>
                <h2 className="text-2xl font-bold mb-4 text-[#CC0000]">{ind.title}</h2>
                <p className="text-gray-600 leading-relaxed mb-6">{ind.description}</p>
                <Link href="/support" className="text-[#CC0000] hover:text-[#b30000] text-sm font-medium transition-colors">Learn more about {ind.title} solutions →</Link>
              </div>
