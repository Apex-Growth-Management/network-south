        ...
        >
          <div className="bg-gray-900 border border-white/10 rounded-2xl px-5 py-4 flex items-center gap-4 shadow-2xl shadow-black/40">
            <div className="flex-1 min-w-0">
              ...
              <p className="text-white/50 text-xs mt-0.5">Free consultation — no obligation.</p>
            </div>
            <div className="flex items-center gap-2 shrink-0">
              <a
                href="tel:8009489914"
                className="inline-flex items-center gap-1.5 bg-[#CC0000] hover:bg-[#b30000] text-white text-sm font-semibold px-4 py-2 rounded-full transition-colors"
              >
